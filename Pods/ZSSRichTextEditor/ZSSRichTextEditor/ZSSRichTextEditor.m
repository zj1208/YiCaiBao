...
- (void)viewDidLoad {
    ...
    self.sourceView.textColor = [UIColor redColor];
    ...
    [self buildToolbar];
     */
     self.toolbarHolder = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height, self.view.frame.size.width, 60)];
    self.toolbarHolder.backgroundColor = [UIColor colorWithWhite:0 alpha:0.3];
    [self.view addSubview:self.toolbarHolder];

    UIButton *centerBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [centerBtn setBackgroundColor:[UIColor colorWithRed:253.f/255 green:77.f/255 blue:55.f/255 alpha:1]];
    centerBtn.frame = CGRectMake(15, 8, self.view.frame.size.width-30-40-15, self.toolbarHolder.frame.size.height-16);
    [centerBtn setTitle:@"添加图片" forState:UIControlStateNormal];
    centerBtn.titleLabel.font = [UIFont systemFontOfSize:17];
    centerBtn.layer.cornerRadius = CGRectGetHeight(centerBtn.frame)/2;
    ...
    [self.toolbarHolder addSubview:centerBtn];
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setImage:[UIImage imageNamed:@"ic_jianpan"] forState:UIControlStateNormal];
    button.frame = CGRectMake(self.view.frame.size.width-55, 0, 40, self.toolbarHolder.frame.size.height);
...
- (void)centerBtnAction:(id)sender
{
...
- (void)insertImage {
    ...
    [self showInsertImageDialogWithLink:self.selectedImageURL alt:nil];
...
- (void)keyboardWillShowOrHide:(NSNotification *)notification {
    ...
    if ([notification.name isEqualToString:UIKeyboardWillShowNotification]) {
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
            ...
            [self setContentHeight: self.editorView.frame.size.height - safeBottom - sizeOfToolbar - 10];

...
- (NSArray *)defaultMediaItems
{
    return @[[NIMMediaItem item:@"onTapMediaItemPicture:"
                    normalImage:[UIImage nim_imageInKit:@"ic_picture"]
                  selectedImage:[UIImage nim_imageInKit:@"ic_picture"]
                          title:@"相册"],
             
             [NIMMediaItem item:@"onTapMediaItemShoot:"
                    normalImage:[UIImage nim_imageInKit:@"ic_photo"]
                  selectedImage:[UIImage nim_imageInKit:@"ic_photo"]
                          title:@"拍摄"],
...
//    _cellBackgroundColor = NIMKit_UIColorFromRGB(0xE4E7EC);
    _cellBackgroundColor = NIMKit_UIColorFromRGB(0xf3f3f3);

...
//    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"icon_toolview_voice_pressed"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"ic_microphone"]:[UIImage nim_imageInKit:@"ic_microphone"] forState:UIControlStateNormal];
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"ic_microphone"]:[UIImage nim_imageInKit:@"ic_microphone"] forState:UIControlStateHighlighted];
}

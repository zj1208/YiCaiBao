...
+ (void)jl_showGifWithGifName:(NSString *)gifName imagesCount:(NSInteger )imgCount toView:(nullable UIView *)view
{
    ...
    UIImageView *gifView = [[UIImageView alloc]initWithFrame:CGRectMake(0,0,LCDScale_iPhone6_Width(image.size.width/3), LCDScale_iPhone6_Width(image.size.height/3))];

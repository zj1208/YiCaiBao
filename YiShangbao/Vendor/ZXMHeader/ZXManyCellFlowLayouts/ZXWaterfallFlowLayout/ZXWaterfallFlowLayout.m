...
static CGFloat const itemDefaultHeigth =80.f;
static CGFloat const itemMaxScale = 5.f/4.f;
static CGFloat const itemMinScale = 1.f/2.f;
...
//    NSInteger sectionCount = [self.collectionView numberOfSections];
    ...
    if ([self.collectionView.dataSource respondsToSelector:@selector(collectionView:viewForSupplementaryElementOfKind:atIndexPath:)])
    {
        ...
        [self.attributesMArray addObject:headerAttrs];

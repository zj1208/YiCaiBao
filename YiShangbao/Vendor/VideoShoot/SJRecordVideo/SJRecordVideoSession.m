...
@property (nonatomic, strong, readwrite) void(^pausedCallBlock)(void);
 ...
 *  暂停录制
 */
- (void)pauseRecordingAndComplete:(void (^)(void))block {
    if ( ![self isRecording] ) {
        if ( block ) block();
        return;
    }
 ...
 *  重置录制
 */
- (void)resetRecordingAndCallBlock:(void(^)(void))block {

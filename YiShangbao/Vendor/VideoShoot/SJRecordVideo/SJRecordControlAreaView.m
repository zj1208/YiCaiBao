...
- (void)setExeSelectTime1Block:(void (^)(void))exeSelectTime1Block {
    ...
    void(^block)(void) = [exeSelectTime1Block copy];
    __weak typeof(self) _self = self;
...
- (void (^)(void))exeSelectTime1Block {
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setExeSelectTime2Block:(void (^)(void))exeSelectTime2Block {
    objc_setAssociatedObject(self, @selector(exeSelectTime2Block), exeSelectTime2Block, OBJC_ASSOCIATION_COPY_NONATOMIC);
    void(^block)(void) = [exeSelectTime2Block copy];
    __weak typeof(self) _self = self;

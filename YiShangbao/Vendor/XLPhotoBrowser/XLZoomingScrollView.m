...
@property (nonatomic) BOOL isCanDoubleTap;
...
- (void)setShowHighQualityImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    self.isCanDoubleTap = NO;
    [self.photoImageView sd_setImageWithURL:url placeholderImage:placeholder options:SDWebImageRetryFailed| SDWebImageLowPriority| SDWebImageHandleCookies progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
...
- (void)setMaxAndMinZoomScales
{
    ...
    if (self.photoImageView.xl_height > XLScreenH) {
        ...
        self.photoImageView.xl_width = XLScreenH * imageWidthHeightRatio;
        self.photoImageView.xl_height = XLScreenH;

//
//  WYLosePurchaserShoppingCartTableViewCell.m
//  YiShangbao
//
...
NSString * const WYLosePurchaserShoppingCartTableViewCellID = @"WYLosePurchaserShoppingCartTableViewCellID";

@interface WYLosePurchaserShoppingCartTableViewCell()
...
@implementation WYLosePurchaserShoppingCartTableViewCell
...
- (void)updateData:(id)model{
    if ([model isKindOfClass:[WYShopCartLoseGoodsModel class]]) {
        WYShopCartLoseGoodsModel *goodsModel = model;
        self.titleLabel.text = goodsModel.name;
        self.goodsInfolabel.text = goodsModel.spec;
        [self.goodsImageView sd_setImageWithURL:[NSURL ossImageWithResizeType:OSSImageResizeType_w200_hX relativeToImgPath:goodsModel.picUrl] placeholderImage:AppPlaceholderImage];
    }
}

...
//
//  视频播放那边要用，只用于图片时候； image编码解码被我注释了
...
- (void)viewDidLoad {
    ...
    self.collectionView.backgroundColor = UIColorFromRGB_HexValue(0x1d1d1d);
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _durationLabel.textColor = UIColorFromRGB_HexValue(0xffffff);
        _durationLabel.shadowColor = UIColorFromRGB_HexValue(0x0);
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _titleLabel.textColor = UIColorFromRGB_HexValue(0xffffff);

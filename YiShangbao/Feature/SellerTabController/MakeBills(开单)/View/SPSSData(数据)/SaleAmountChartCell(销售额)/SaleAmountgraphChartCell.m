...
@implementation SaleAmountgraphChartCell
...
//    self.dateLab.font = [UIFont systemFontOfSize:LCDScale_iPhone6_Width(15.f)];
    ...
    PNLineChart *lineChart = [[PNLineChart alloc] initWithFrame:CGRectMake(10,55, SCREEN_WIDTH-20, 185.f)];
    ...
    lineChart.yLabelFont = [UIFont systemFontOfSize:LCDScale_iPhone6_Width(10)];
...
//    saleAmount = [saleAmount subarrayWithRange:NSMakeRange(0, 1)];
...
//    if (saleAmount.count>7 && saleAmount.count<10)
//    {
//        self.lineChart.xLabelFont = [UIFont systemFontOfSize:LCDScale_iPhone6_Width(10)];
//
//    }
//    else
//    {
//        self.lineChart.xLabelFont = [UIFont systemFontOfSize:LCDScale_iPhone6_Width(12)];
//    }

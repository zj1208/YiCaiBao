...
- (void)awakeFromNib {
    ...
    PNPieChart *pieChart = [[PNPieChart alloc] initWithFrame:CGRectMake(LCDScale_iPhone6_Width(46), 16, 120, 120) items:nil];
    ...
    self.customCellCollectionView.itemSize = CGSizeMake(LCDW/2-2*15, (178  -10-10-3*10)/4);
}

...
-(void)defaultSetting {
    ...
    _accentNickName = [[NSArray alloc] initWithObjects:NSLocalizedString(@"langCant", nil), NSLocalizedString(@"langChin", nil), NSLocalizedString(@"langEng", nil), NSLocalizedString(@"langSzec", nil), nil];

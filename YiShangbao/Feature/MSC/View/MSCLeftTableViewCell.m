...
-(void)setModel:(MSCTranslationModel *)model
{
    ...
    if (model.TranslationFailure) {
        self.englishLabel.text = [NSString stringWithFormat:@"%@",model.TranslationFailure];
        self.englishLabel.textColor = [WYUISTYLE colorWithHexString:@"45a4e8"];
    }else{
        self.englishLabel.text = [NSString stringWithFormat:@"%@",model.english];
        self.englishLabel.textColor = [WYUISTYLE colorWithHexString:@"2f2f2f"];
    }
}
